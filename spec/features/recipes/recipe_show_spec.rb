...
RSpec.describe 'Recipe', type: :feature do
  ...
  describe 'Visit the show page of recipes' do
    ...
    before do
      ...
      food = Food.create(id: 704767, user: user, name: 'Orange', measurement_unit: 'grams', price: 1.50, quantity: 5)
      RecipeFood.create(id: 9843830, recipe: @recipe, food: food, quantity: 1)

      @recipe_modify = Recipe.create(id: 40596739, user: user, name: 'Recipe for test modify', preparation_time: 180, cooking_time: 120, description: 'Test recipe details', public: true)
      @recipe_food_modify = RecipeFood.create(id: 6843830, recipe: @recipe_modify, food: food, quantity: 2)
